 ...
 * ```
 */
export declare type CallbackForRequest<T extends "xhr" | "fetch"> = {
    /**
 ...
 * ```
 */
export declare type ListenerForRequest<T extends "xhr" | "fetch"> = (this: T extends "xhr" ? XMLHttpRequest : unknown, request: T extends "xhr" ? RequestByXHR : RequestByFetch, sendResponse?: CallbackForRequest<T>) => unknown;
/**
 ...
 * ```
 */
export declare type ListenerForResponse<T extends "xhr" | "fetch"> = (this: T extends "xhr" ? XMLHttpRequest : unknown, request: T extends "xhr" ? RequestByXHR : RequestByFetch, response: T extends "xhr" ? ResponseByXHR : ResponseByFetch, next?: CallbackForResponse<T>) => unknown;
/**
